...
public class XingeApp {
	...
	*/
	 ...
	 * @return
	 */
	public static JSONObject pushTokenAndroid(long accessId, String secretKey, Message message, String token)
	{
		XingeApp xinge = new XingeApp(accessId, secretKey);	
		JSONObject ret = xinge.pushSingleDevice(token, message);
		return (ret);
	...
	public static JSONObject pushAllAndroid(long accessId, String secretKey, Message message) {
		XingeApp xinge = new XingeApp(accessId, secretKey);	
		JSONObject ret = xinge.pushAllDevice(0, message);
		return (ret);
	}
	...
	public static JSONObject pushTokenIos(long accessId, String secretKey, MessageIOS message, String token, int env)
	{
		XingeApp xinge = new XingeApp(accessId, secretKey);	
		JSONObject ret = xinge.pushSingleDevice(token, message, env);
		return (ret);
	...
	public static JSONObject pushAllIos(long accessId, String secretKey, MessageIOS message, int env)
	{
		XingeApp xinge = new XingeApp(accessId, secretKey);	
		JSONObject ret = xinge.pushAllDevice(0, message, env);
		return (ret);
