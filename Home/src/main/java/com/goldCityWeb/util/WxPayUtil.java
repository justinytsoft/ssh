...
public class WxPayUtil {
	...
	//API的地址
    //private static String apiURL="tttttttt";
    ...
    public WxPayUtil() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        init();
    }
     ...
     * @throws Exception
     */
    public String requestPay(String apiURL, PayReqData payReqData) throws Exception{
    	return sendPost(apiURL,payReqData);
    }
